...
function resolveConfig(configuration) {
  var cfg = Object.assign(Object.assign({}, defaultConfig), configuration);
  validateConfig(cfg);
  (0,_Log__WEBPACK_IMPORTED_MODULE_3__.init)(cfg);
  return cfg;
}
...
/* harmony export */ });
/* harmony import */ var _VbrickVideoEmbed__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./VbrickVideoEmbed */ "./src/VbrickVideoEmbed.ts");
...
function embedVideo(element, videoId, config) {
  var el = (0,_util__WEBPACK_IMPORTED_MODULE_1__.lookupElement)(element);
  var cfg = (0,_Config__WEBPACK_IMPORTED_MODULE_2__.resolveConfig)(config);
  var video = new _VbrickVideoEmbed__WEBPACK_IMPORTED_MODULE_0__.VbrickVideoEmbed(videoId, cfg, el);
  video.initialize();
  return video;
}
...
/* harmony export */ });
/* harmony import */ var _VbrickWebcastEmbed__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./VbrickWebcastEmbed */ "./src/VbrickWebcastEmbed.ts");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./util */ "./src/util.ts");
/* harmony import */ var _Config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Config */ "./src/Config.ts");
...
function embedWebcast(element, webcastId, config) {
  var el = (0,_util__WEBPACK_IMPORTED_MODULE_1__.lookupElement)(element);
  var cfg = (0,_Config__WEBPACK_IMPORTED_MODULE_2__.resolveConfig)(config);
  var webcast = new _VbrickWebcastEmbed__WEBPACK_IMPORTED_MODULE_0__.VbrickWebcastEmbed(webcastId, cfg, el);
  webcast.initialize();
  return webcast;
}
...
var EventBus = /*#__PURE__*/function () {
  function EventBus(iframe, config) {
  ...
  _createClass(EventBus, [{
    ...
    key: "awaitEvent",
    value: function awaitEvent(event, failEvent) {
      var _this2 = this;
      ...
      return new Promise(function (resolve, reject) {
        var handler = function handler(fn) {
          return function (e) {
            ...
            _this2.off(event, onEvent);

            _this2.off(failEvent, onErr);

            clearTimeout(timer);
          };
        };

        var onEvent = handler(resolve);
        var onErr = handler(reject);

        _this2.on(event, onEvent);

        if (failEvent) {
          _this2.on(failEvent, onErr);
        }

        var timer = setTimeout(function () {
          return onErr(event + ': timeout');
        }, timeout);
      });
    }
  }, {
    ...
    key: "publish",
    value: function publish(event, msg) {
    ...
    key: "publishError",
    value: function publishError(msg, err) {
    ...
    key: "callHandlers",
    value: function callHandlers(event, data) {
      var handlers = this.getHandlers(event);
...
/* harmony export */ });
/* harmony import */ var _WebcastStatus__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./WebcastStatus */ "./src/WebcastStatus.ts");
/* harmony import */ var _PlayerStatus__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PlayerStatus */ "./src/PlayerStatus.ts");
...
/* harmony import */ var _EventBus__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./EventBus */ "./src/EventBus.ts");
/* harmony import */ var _Log__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./Log */ "./src/Log.ts");
...
var VbrickEmbed = /*#__PURE__*/function () {
  function VbrickEmbed(iframeUrl, config, container) {
    _classCallCheck(this, VbrickEmbed);
  ...
  _createClass(VbrickEmbed, [{
    ...
    value: function initialize() {
      ...
      this.eventBus = new _EventBus__WEBPACK_IMPORTED_MODULE_12__.EventBus(this.iframe, this.config);
      this.initializeEmbed();
      this.init = Promise.all([this.initializeToken(), this.eventBus.awaitEvent('load', 'error')]).then(function (_ref) {
        var _ref2 = _slicedToArray(_ref, 1),
            token = _ref2[0];

        (0,_Log__WEBPACK_IMPORTED_MODULE_13__.getLogger)().log('embed loaded, authenticating');

        _this.eventBus.publish('authenticated', {
          token: token
        });
      }).catch(function (err) {
        (0,_Log__WEBPACK_IMPORTED_MODULE_13__.getLogger)().error('Embed initialization error: ', err);

        _this.eventBus.publishError('Error loading embed content', err);
      });
      return this.init;
    }
  }, {
    ...
    value: function destroy() {
      ...
      this.init = null;
      (_a = this.unsubscribes) === null || _a === void 0 ? void 0 : _a.forEach(function (fn) {
        return fn();
      });
    }
  }]);
...
/* harmony import */ var _IVbrickApi__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./IVbrickApi */ "./src/IVbrickApi.ts");
/* harmony import */ var _VbrickEmbed__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./VbrickEmbed */ "./src/VbrickEmbed.ts");
...
var VbrickVideoEmbed = /*#__PURE__*/function (_VbrickEmbed) {
  _inherits(VbrickVideoEmbed, _VbrickEmbed);

  var _super = _createSuper(VbrickVideoEmbed);

  function VbrickVideoEmbed(videoId, config, container) {
    var _this;

    _classCallCheck(this, VbrickVideoEmbed);

    _this = _super.call(this, getEmbedUrl(videoId, config), config, container);
  ...
  */
  ...
  _createClass(VbrickVideoEmbed, [{
    ...
    */
    ...
    value: function initializeToken() {
      if (this.config.token.type !== _IVbrickApi__WEBPACK_IMPORTED_MODULE_20__.TokenType.ACCESS_TOKEN) {
    ...
    key: "initializeEmbed",
    value: function initializeEmbed() {
      var _this2 = this;

      this.eventBus.on('playerStatusChanged', function (e) {
        return _this2._playerStatus = e.status;
      }), this.eventBus.on('volumeChanged', function (e) {
        return _this2._volume = e.volume;
      }), this.eventBus.on('captionsChanged', function (e) {
        return _this2._captions = e.captions;
      });
    }
  }, {
    key: "destroy",
    value: function destroy() {
      ...
      _get(_getPrototypeOf(VbrickVideoEmbed.prototype), "destroy", this).call(this);
  ...
  return VbrickVideoEmbed;
}(_VbrickEmbed__WEBPACK_IMPORTED_MODULE_21__.VbrickEmbed);

function getEmbedUrl(id, config) {
  return [["".concat(config.baseUrl, "/embed?"), true], ['tk', !!config.token], ['id', id], ['accent', config.accentColor], ['autoplay', config.autoplay], ['forceClosedCaptions', config.forcedCaptions], ['loopVideo', config.playInLoop], ['noCc', config.hideCaptions], ['noCenterButtons', config.hideOverlayControls], ['noChapters', config.hideChapters], ['noFullscreen', config.hideFullscreen], ['noPlayBar', config.hidePlayControls], ['noSettings', config.hideSettings], ['placeholder', config.popOut], ['startAt', config.startAt]].map(function (_ref) {
    var _ref2 = _slicedToArray(_ref, 2),
        key = _ref2[0],
        value = _ref2[1];

    return !value ? undefined : value === true ? key : "".concat(key, "=").concat(encodeURIComponent(value));
  }).filter(Boolean).join('&');
}

/***/ }),

/***/ "./src/VbrickWebcastEmbed.ts":
/*!***********************************!*\
  !*** ./src/VbrickWebcastEmbed.ts ***!
  \***********************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _VbrickEmbed__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./VbrickEmbed */ "./src/VbrickEmbed.ts");
/* harmony import */ var _auth__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./auth */ "./src/auth.ts");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var VbrickWebcastEmbed = /*#__PURE__*/function (_VbrickEmbed) {
  _inherits(VbrickWebcastEmbed, _VbrickEmbed);

  var _super = _createSuper(VbrickWebcastEmbed);

  function VbrickWebcastEmbed(webcastId, config, container) {
    var _this;

    _classCallCheck(this, VbrickWebcastEmbed);

    _this = _super.call(this, new URL("/embed/webcast/".concat(webcastId).concat(config.token ? '?tk' : ''), config.baseUrl).toString(), config, container);
    _this.webcastId = webcastId;
    return _this;
  }

  _createClass(VbrickWebcastEmbed, [{
    key: "status",
    get: function get() {
      return this._status;
    }
    ...
    key: "initializeToken",
    value: function initializeToken() {
      return (0,_auth__WEBPACK_IMPORTED_MODULE_13__.initializeWebcastToken)(this.webcastId, this.config);
    }
  }, {
    key: "initializeEmbed",
    value: function initializeEmbed() {
      ...
      ['webcastStarted', 'broadcastStarted', 'broadcastStopped', 'webcastEnded'].forEach(function (event) {
        _this2.eventBus.on(event, function (data) {
          return _this2._status = data.status;
        });
      });
      this.eventBus.awaitEvent('webcastLoaded').then(function (data) {
        _this2._status = data.status;
      });
    }
  }]);

  return VbrickWebcastEmbed;
}(_VbrickEmbed__WEBPACK_IMPORTED_MODULE_12__.VbrickEmbed);

/***/ }),

/***/ "./src/WebcastStatus.ts":
/*!******************************!*\
  !*** ./src/WebcastStatus.ts ***!
  \******************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _IVbrickApi__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./IVbrickApi */ "./src/IVbrickApi.ts");
...
function getToken(webcastId, config) {
  ...
  if (config.token.type === _IVbrickApi__WEBPACK_IMPORTED_MODULE_4__.TokenType.ACCESS_TOKEN) {
    return Promise.resolve({
  ...
  return fetch("".concat(config.baseUrl, "/external/auth/jwt/").concat(webcastId), {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'x-requested-with': 'xmlhttprequest'
    },
    body: "{\n\t\t\t\t\"token\": \"".concat(issuer, " ").concat(token, "\"\n\t\t\t}")
...
function lookupElement(element) {
  var el = element instanceof HTMLElement ? element : document.querySelector(element);
...
/* harmony export */   "embedWebcast": function() { return /* reexport safe */ _EmbedWebcast__WEBPACK_IMPORTED_MODULE_1__.embedWebcast; },
/* harmony export */   "embedVideo": function() { return /* reexport safe */ _EmbedVideo__WEBPACK_IMPORTED_MODULE_2__.embedVideo; }
/* harmony export */ });
/* harmony import */ var _Config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Config */ "./src/Config.ts");
/* harmony import */ var _EmbedWebcast__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./EmbedWebcast */ "./src/EmbedWebcast.ts");
/* harmony import */ var _EmbedVideo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./EmbedVideo */ "./src/EmbedVideo.ts");
/**
