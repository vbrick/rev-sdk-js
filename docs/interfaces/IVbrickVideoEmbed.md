...
- [`IVbrickBaseEmbed`](IVbrickBaseEmbed.md)\<[`IVideoInfo`](IVideoInfo.md), keyof [`TEmbedMessages`](../type-aliases/TEmbedMessages.md) & [`TPlayerMessages`](../type-aliases/TPlayerMessages.md)\>
